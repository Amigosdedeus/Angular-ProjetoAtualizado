...
public class DBService {
    ...
    public void instanciaDB() {
        ...
        logger.info("Técnico criado: {} com email: {} e perfil: {}", tec1.getNome(), tec1.getEmail(), tec1.getPerfis());
        ...
        // Salvando todos no banco de dados
        pessoaRepository.saveAll(Arrays.asList(tec1, tec2, tec3, tec4, tec5, cli1, cli2, cli3, cli4, cli5));
        logger.info("Técnicos e clientes salvos no banco de dados.");

        chamadoRepository.saveAll(Arrays.asList(c1, c2, c3, c4, c5, c6));
        logger.info("Chamados salvos no banco de dados.");
